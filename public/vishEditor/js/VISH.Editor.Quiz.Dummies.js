VISH.Editor.Quiz.Dummies = (function(V,undefined){
	var quizDummies = [];
	...
	var init = function(){
		...
		quizOptionDummies = ["", 
		"<li class='li_mch_options_in_zone'><span class='quiz_option_index'></span><div class='multiplechoice_option_in_zone'><div class='initTextDiv'><font size='4'>Write options here</font></div></div><img src='"+V.ImagesPath+ "icons/add.png' class='add_quiz_option_button'/><img src='"+V.ImagesPath+ "icons/ve_delete.png' class='delete_quiz_option_button'/></li>", 
