VISH.Editor.Quiz.Dummies = (function(VISH,undefined){
	...
	var init = function(){
		...
		"<div class='truefalse_options'><div class='truefalse_titles'><div class='truefalse_titles_true'>True</div><div class='truefalse_titles_false'>False</div></div><div class='truefalse_answers'><form method='post'><input class='truefalse_answer_radio_true' type='radio' name='truefalse_answer' value='true'/><input class='truefalse_answer_radio_false' type='radio' name='truefalse_answer' value='false'/></form></div></div>"
		];
