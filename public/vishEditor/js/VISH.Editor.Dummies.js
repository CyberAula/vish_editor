VISH.Editor.Dummies = (function(V,undefined){
	...
	var init = function(){
		...
		"<article id='article_id_to_change' type='standard' template='t19' slidenumber='slidenumber_to_change'><div class='delete_slide'></div><img class='help_in_slide help_in_sslide' src='"+V.ImagesPath+"vicons/helptutorial_circle_blank.png'/><div id='div_id_to_change' areaid='header'  size='small'  class='t19_header editable vezone selectable'></div>  <div id='div_id_to_change' areaid='center'  size='large'  class='t19_center editable vezone selectable'></div>  <div id='div_id_to_change' areaid='bottom'  size='small'  class='t19_bottom editable vezone selectable'></div></article>",
