...
VISH.QuizCharts = (function(V,$,undefined){
	...
	var init = function(options){
		...
		_insertCss("div.openQuizAnswerLeft{position: absolute; width: 5%; height: 70%; top: 15%; left: 3%; background-image: url('/vishEditor/images/vicons/userAnswer.png'); background-position: center; background-size: contain; background-repeat: no-repeat;} div.openQuizAnswerRight{ margin-left: 5%; };");
	};
