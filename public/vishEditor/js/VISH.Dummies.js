VISH.Dummies = (function(VISH,undefined){
	...
	var init = function(){
		...
		"<div class='multipleChoiceQuizContainer'><textarea class='value_multiplechoice_question_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea><ul class='ul_mch_options_in_zone'><li class='li_mch_options_in_zone '><span>a)</span><textarea class='multiplechoice_option_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea></li><li class='li_mch_options_in_zone '><span>b)</span><textarea class='multiplechoice_option_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea></li> <li class='li_mch_options_in_zone '><span>c)</span><textarea class='multiplechoice_option_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea></li><li class='li_mch_options_in_zone '><span>d)</span><textarea class='multiplechoice_option_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea></li><li class='li_mch_options_in_zone '><span>e)</span><textarea class='multiplechoice_option_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea></li><li class='li_mch_options_in_zone '><span>f</span><textarea class='multiplechoice_option_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></textarea></li></ul><input type='hidden' name='quiz_id'/></div></div>",
