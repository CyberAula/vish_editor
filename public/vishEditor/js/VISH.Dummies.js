VISH.Dummies = (function(VISH,undefined){
	...
	var init = function(){
		...
		"<div class='multipleChoiceQuizContainer'><div class='value_multiplechoice_question_in_zone' placeholder='write question here' ><font size='4'>Write question here</font></div><ul class='ul_mch_options_in_zone'><li class='li_mch_options_in_zone'><span>a)</span><div class='multiplechoice_option_in_zone' placeholder='write options here'><font size='4'>Write options here</font></div></li><li class='li_mch_options_in_zone'><span>b)</span><div class='multiplechoice_option_in_zone' placeholder='write options here'><font size='4'>Write options here</font></div></li><li class='li_mch_options_in_zone'><span>c)</span><div class='multiplechoice_option_in_zone' placeholder='write options here'><font size='4'>Write options here</font></div></li><li class='li_mch_options_in_zone'><span>d)</span><div class='multiplechoice_option_in_zone' placeholder='write options here'><font size='4'>Write options here</font></div></li><li class='li_mch_options_in_zone'><span>e)</span><div class='multiplechoice_option_in_zone' placeholder='write options here'><font size='4'>Write options here</font></div></li><li class='li_mch_options_in_zone'><span>f)</span><div class='multiplechoice_option_in_zone' placeholder='write options here'><font size='4'>Write options here</font></div></li></ul><input type='hidden' name='quiz_id'/></div></div>",
