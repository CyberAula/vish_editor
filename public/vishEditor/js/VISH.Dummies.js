VISH.Dummies = (function(VISH,undefined){
	...
	var dummies = [
		...
		"<article id='article_id_to_change' template='t12'><div class='delete_slide'></div><div id='div_id_to_change' areaid='left' class='t12_left truefalsequestion' type='truefalsequestion'><h2 class='header_truefalse_question'>True/False Question:</h2><table id='truefalse_quiz_table' class='truefalse_quiz_table'><tr><th>True</th><th>False</th><th> Question </th><th></th></tr><tr id='tr_question_1'><td id='td_true_1'><input type='radio' id='true_1' name='asnswer_1'/></td><td id='td_false_1'><input type='radio' id='false_1' name='asnswer_1'/></td><td id='td_question_1'><textarea rows='1' cols='50' class='true_false_question' placeholder='Write question here' id='true_false_question_1'></textarea></td><td><a id='a_add_true_false_question' ><img src='"+VISH.ImagesPath+"/add_quiz_option.png' /></a> </td></tr>              </table></div></article>"
		]; 
