		...
		{ "es":
			{
				...
				"i.walkVideosUpload_2"		: "Puedes subir un vídeo propio de tu ordenador. Para hacer esto, vete a",
				"i.walkVideosUpload_3"		: "y sube tu archivo de vídeo al repositorio del ViSH. Varios formatos de vídeo (mp4, flv, mpg, avi, ...) están soportados. Cuando termines de subir el vídeo al ViSH tu vídeo será convertido a un formato compatible con HTML5. Este proceso puede llevar varios minutos. Una vez que el proceso haya finalizado, tienes dos formas de añadir un vídeo",
				"i.walkVideosUpload_4"		: "Buscar tu vídeo en el repositorio del ViSH en la pestaña 'ViSH'. En este caso tendrás que esperar varias horas hasta que el motor de búsqueda del ViSH haya indexado el nuevo vídeo. Esta es la manera recomendada de insertar los videos, porque de este modo los vídeos estarán disponibles en varios formatos y funcionarán en casi todos los dispositivos.",
